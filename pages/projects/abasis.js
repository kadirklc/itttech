...
const sendMassage = (data) => {
    ...
    let text = `ittyazilim.com üzerinden bir adet iletişim formu alındı(abasis):%0A%0A - İsim: ${massage.name}%0A - Mail: ${massage.email}%0A - Mesaj: ${massage.msg}`;
...
const NewsDetailsPage = () => (
    <Layout pageTitle="ITT | Abasis">
        <NavTwo />
        <PageHeader title="ABASİS" />
        <AbasisDetail/>
        <ScreenshotsApp/>
        <div className={"mb-5"}>
            <Video />
